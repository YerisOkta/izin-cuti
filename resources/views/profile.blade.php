   ...
   <body>
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                <span class="text-muted text-xs block">Test<b class="caret"></b></span>
                            </a>
                    ...
                    <li>
                        <a href="/kedua"><i class="fa fa-flask"></i> <span class="nav-label">UI Elements</span></a>
                    <li>
        ...
        <div class="navbar-header">
            ...
            <div class="footer">
                <div>
                    <strong>Copyright</strong> Yeris Ganteng &copy; 1945-2019
                </div>
            </div>
        </div>
